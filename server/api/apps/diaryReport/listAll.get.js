export default defineEventHandler(async (event) => {
  try {
    ...
    const formattedReports = diaryReports.map(report => ({
      ...
      two_way_communication: report.two_way_communication,
      emotional_regulation: report.emotional_regulation,
      focus_and_comprehension: report.focus_and_comprehension,
      feeding_and_sensory: report.feeding_and_sensory,
      sleep_and_daily_routines: report.sleep_and_daily_routines,
      socialisation_self_confidence: report.socialisation_self_confidence,
      date: report.date,
